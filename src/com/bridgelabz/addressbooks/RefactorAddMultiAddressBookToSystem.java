...
public class RefactorAddMultiAddressBookToSystem {
	...
	static RefactorAddMultiAddressBookToSystem addContact = new RefactorAddMultiAddressBookToSystem();
	...
	public void createAddressBook() {
		...
		while (true) {
			...
			case 1:
				...
				ArrayList<ContactsDetails> new_address_book = new ArrayList<>();
			...
			case 2:
				...
				if (hashmap.containsKey(address_name_old)) {
					...
					ArrayList<ContactsDetails> old_address_book = new ArrayList<>();
